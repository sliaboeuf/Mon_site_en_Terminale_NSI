...
|Disques  				|
|:---------------: 		|
|<u markdown="1">__Code disque__</u>	|
|titre        			|
|année               	|
...
#### <div class = "encadré9_BDD" markdown="1">Formalisme des cardinalités : les différentes valeurs</div>
...
<center markdown="1">
	...
	![](Images/Fleche.png){width=5% height=5% class="picture"}
...
#### <div class = "encadré15_BDD" markdown="1">Si les deux cardinalités maximales sont N</div>
