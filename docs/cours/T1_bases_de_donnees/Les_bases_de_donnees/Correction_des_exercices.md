...
# <center markdown="1"><div class = "titre2"> Correction des exercices </div></center>

### <div class = "encadré_exo"> __Correction de l'exercice 1__ </div>
<div class="list1_1" markdown="1">

1. Dans le cas où la discothèque ne comprend aucune compilation de différents artistes, on obtient le MCD suivant :<span style="display: block; margin: 5px 0 0 0;">
![](images/Ex1_1_MCD.svg){style="width: 50%" .image}
Ce qui donne alors, comme MLD :
![](images/Ex1_1_MLD.jpg){style="width: 75%" .image}</span>
<br>
2. Et dans le cas où la discothèque comprend des compilations, on obtient le MCD suivant :<span style="display: block; margin: 5px 0 0 0;">
![](images/Ex1_2_MCD.svg){style="width: 50%" .image}
Ce qui donne alors, comme MLD :
![](images/Ex1_2_MLD.jpg){style="width: 75%" .image}</span>
...
1. Dans le cas où toutes les pièces d'une même référence possèdent un prix unique, on obtient le MCD suivant :<span style="display: block; margin: 5px 0 0 0;">
![](images/Ex2_1_MCD.svg){style="width: 50%" .image}
Ce qui donne alors, comme MLD :
![](images/Ex2_1_MLD.jpg){style="width: 100%" .image}</span>
<br>
2. Et dans le cas où chaque pièce possède un prix propre, on obtient le MCD suivant :<span style="display: block; margin: 5px 0 0 0;">
![](images/Ex2_2_MCD.svg){style="width: 50%" .image}
Ce qui donne alors, comme MLD :
![](images/Ex2_2_MLD.jpg){style="width: 100%" .image}</span>
...
<span style="display: block; margin: 5px 0 0 0;">L'identifiant est ici l'attribut « *Numero* ». Il peut donc y avoir des clients homonymes, ces clients auront des numéros différents.</span>
...
### <div class = "encadré_exo" markdown="1"> __Correction de l'exercice 4__ </div>
...
### <div class = "encadré_exo" markdown="1"> __Correction de l'exercice 5__ </div>
<div class="list1_1" markdown="1">
...
<span style="display: block; margin: 3px 0 0 0;">De même, seul un patient assiste à une consultation. Cela est également spécifié par la cardinalité `(1,1)` côté « Consultation » sur l'association « Assister ».</span>
