# <center><div class = "titre7">Fonction : sequence_to_occurrences()</div></center>
...
![Illustration](images/Frequence.jpg){: .image}
...
assert type(sequence_to_occurrences('aaabc')) == type({}), "Votre fonction ne renvoie pas un dictionnaire"
assert sequence_to_occurrences('aaabc') == {'a': 3, 'b': 1, 'c': 1}, "Erreur"
assert sequence_to_occurrences('dictionnaire') == {'d': 1, 'i': 3, 'c': 1, 't': 1, 'o': 1, 'n': 2, 'a': 1, 'r': 1, 'e': 1}, "Erreur"
